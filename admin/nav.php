...
<div class="col-12 col-sm-3 col-xl-2 sm-2 px-0 bg-dark d-flex sticky-top" style="background-color:#37474f">
    <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white" style="background-color:#37474f">
        <a href="admin-profile.php" class="d-flex align-items-center pb-sm-3 mb-md-0 me-md-auto text-white text-decoration-none" style="font-size:40px">
            <span class="" style="font-size:36px;">HMP<span class="d-none d-sm-inline" style="font-size:40px;"></span></span>
        </a>
        <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start" id="menu">
            <li class="nav-item">
                <a href="admin-profile.php" class="nav-link px-sm-0 px-2">
                    ...
                    <span class="ms-1 d-none d-sm-inline text-white" style="font-size:18px;">Home</span>
                </a>
            </li>
            <br>
            <li class="dropdown">
                <a href="#" class="nav-link dropdown-toggle px-sm-0 px-2" id="dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <span class="ms-1 d-none d-sm-inline text-white" style="font-size:18px;">Complaints</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdown">
                    <li><a class="dropdown-item" style="font-size:18px;" href="message.php?fil=<?php echo $hos?>">Your Hostel</a></li>
                    <li><a class="dropdown-item" style="font-size:18px;" href="message.php" >Other Hostels</a></li>
            ...
            <li>
                <a href="general.php" class="nav-link px-sm-0 px-2">
                    ...
                    <span class="ms-1 d-none d-sm-inline text-white" style="font-size:18px;">Account</span>
                </a>
            </li>
            <br>
            <li>
                <a href="../logout.php" onClick="javascript:return confirm ('Do you really want to logout ?');" class="nav-link px-sm-0 px-2">
                    ...
                    <span class="ms-1 d-none d-sm-inline text-white" style="font-size:18px;">Logout</span>
                </a>
            </li>
        </ul>
        <div class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <span class="d-none d-sm-inline mx-1" style="font-size:18px">Contacts</span>
            </a>

  ...
  <div class="animated fadeIn">
    ...
    <div class="col-md-auto">
      <div class="col-lg-12">
        ...
        $result = mysqli_query($conn, "SELECT * FROM `cmp_log` WHERE (visibility='Public') ORDER BY `public_cmp_freq` DESC");
        ...
        <div class="list-group" style="margin-right:10px;">
          <ol style="padding-left:25px">
            ...
            while ($data = mysqli_fetch_array($result)) {
              ...
              $t = $data2['time'];
              echo "<small style='color:#37474f'>";
              echo substr($t, 0, 9) ;
              echo "</small>";
              echo '</div>';
              echo '<div class="d-flex justify-content-between">';
              echo "<span class='mb-1' style='color:#666;'>Category: $data[CategoryOfIssue]</span>";
              echo "<span style='color:#666; text-align:right;' class='mb-1'>$s</span>";
              echo '</div>';
              ...
              if ($data['visibility'] == 'Public') {
                echo "
                <medium style='color: red '>$data[visibility] <medium style='background-color: red; border-radius: 8px; padding:4px; color: white'>$data[public_cmp_freq]</medium></medium>
                ";
              }
